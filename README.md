...
- A [Nerd Font](https://www.nerdfonts.com/): optional, provides various icons
  - if you have it set `vim.g.have_nerd_font` in `init.lua` to true (set to true by default here)
- Node.js version 14 or greater
  - Use [Node Version Manager](https://github.com/nvm-sh/nvm/tree/v0.40.0) to install the right version of node.
- Language Setup:
